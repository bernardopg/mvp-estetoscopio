    ...
    return (
      <div className="min-h-screen bg-[var(--color-bg)] flex items-center justify-center">
        <div className="text-center">
          <div className="inline-flex items-center justify-center p-6 rounded-3xl bg-[var(--color-surface)] border border-[var(--color-border)] shadow-xl mb-6">
    ...
    return (
      <div className="min-h-screen bg-[var(--color-bg)] flex items-center justify-center px-4">
        <div className="max-w-md w-full">
          <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl shadow-xl p-12 text-center">
            ...
            <button
              ...
              className="px-6 py-3 bg-[var(--color-accent)] text-white rounded-xl hover:shadow-lg hover:shadow-blue-500/30 transition-all duration-300 inline-flex items-center gap-2 font-semibold"
            >
    ...
    <div className="min-h-screen bg-[var(--color-bg)] py-8 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          <button
            onClick={() => router.push("/comunidades")}
            className="mb-6 text-[var(--color-text-muted)] hover:text-zinc-900 dark:hover:text-zinc-50 transition-colors inline-flex items-center gap-2 font-medium"
          >
              ...
              <div className="flex items-start justify-between gap-6">
                <div className="flex items-start gap-6">
                  ...
                  <div className="pt-4">
                    ...
                    <p className="text-[var(--color-text-muted)] text-lg mb-4 max-w-2xl">
                ...
                <div className="flex flex-col gap-2 pt-4">
                  {!community.isMember ? (
                    <button
                      ...
                      className="px-6 py-3 bg-[var(--color-accent)] text-white rounded-xl hover:shadow-lg hover:shadow-blue-500/30 transition-all duration-300 inline-flex items-center justify-center gap-2 font-semibold"
                    >
                    ...
                    <>
                      ...
                      <button
                        className="px-6 py-3 bg-[var(--color-accent)] text-white rounded-xl hover:shadow-lg hover:shadow-green-500/30 transition-all duration-300 inline-flex items-center justify-center gap-2 font-semibold"
                      ...
                      {(community.userRole === "creator" ||
                        ...
                        <button
                          className="px-6 py-3 bg-[var(--color-accent-soft)] text-[var(--color-text)] rounded-xl hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-colors inline-flex items-center justify-center gap-2 font-semibold"
        ...
        {/* Tabs */}
        <div className="mb-8">
          <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl shadow-lg p-2 inline-flex gap-2">
            <button
        ...
        {activeTab === "decks" && (
          <div className="space-y-4">
            {sharedDecks.length === 0 ? (
              <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl shadow-lg p-16 text-center">
                <div className="max-w-md mx-auto">
                  <div className="w-24 h-24 bg-[var(--color-accent)] dark:from-blue-950/50 dark:to-purple-950/50 rounded-3xl flex items-center justify-center mx-auto mb-6">
              ...
              <div className="grid grid-cols-1 gap-4">
                {sharedDecks.map((shared) => (
                  <div
                    key={shared.id}
                    className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group"
                  >
                    <div className="p-6">
                      <div className="flex items-start justify-between gap-6">
                          ...
                          <div className="flex items-start gap-4 mb-4">
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center gap-2 mb-2 flex-wrap">
                                <h3 className="text-2xl font-bold text-[var(--color-text)] truncate">
                                  {shared.deck.title}
                                </h3>
                        ...
                        <div className="flex flex-col gap-2">
                          <button
                            onClick={() =>
                              router.push(`/baralhos/estudar?id=${shared.deck_id}`)
                            }
                            className="px-6 py-3 bg-[var(--color-accent)] text-white rounded-xl hover:shadow-lg hover:shadow-blue-500/30 transition-all duration-300 inline-flex items-center gap-2 font-semibold whitespace-nowrap"
                          >
                            <BookOpen className="w-5 h-5" />
                            Estudar
                          </button>
                          {shared.permission_level === "clone" && (
                            <button
                              ...
                              className="px-6 py-3 bg-[var(--color-accent)] text-white rounded-xl hover:shadow-lg hover:shadow-green-500/30 transition-all duration-300 inline-flex items-center gap-2 font-semibold whitespace-nowrap"
                            >
                              <Share2 className="w-5 h-5" />
                              Clonar
                            </button>
        ...
        {activeTab === "members" && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {members.map((member) => (
              <div
                key={member.id}
                className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-6"
              >
                <div className="flex flex-col items-center text-center">
                  {/* Avatar */}
                  <div className="w-20 h-20 bg-[var(--color-accent)] rounded-2xl flex items-center justify-center text-white font-bold text-2xl shadow-lg mb-4">
                  ...
                  <div className="mb-3">
                    <span className={`px-3 py-1 rounded-lg text-xs font-semibold ${
                      member.role === "creator"
                        ...
                        : "bg-[var(--color-accent-soft)] text-zinc-700 dark:text-zinc-400"
                    }`}>
